...
CREATE OR REPLACE FUNCTION yukiteru_test(item_name STRING, item_price INT)
RETURNS STRING
RETURN concat("This is yukiteru_test_function" , item_name, "is", item_price);

SELECT * , yukiteru_test(name, price) AS message FROM item_lookup
